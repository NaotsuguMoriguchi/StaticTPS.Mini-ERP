...
class TransactionUtil extends Util
{
    ...
    public function getInvoiceNumber($business_id, $status, $location_id, $invoice_scheme_id = null)
    {
        if ($status == 'final') {
            ...
            $ref_count = $this->setAndGetReferenceCount('draft');
            $invoice_no = $this->generateReferenceNumber('draft', $ref_count);
            return $invoice_no;
        }
        else {
            return Str::random(5);
    ...
    */
    ...
    public function getLedgerDetails($contact_id, $start, $end)
    {
        ...
        $payments = $this->__paymentQuery($contact_id, $start, $end)
                        ...
                        //echo "<pre>";print_r($payments->toArray());exit;
    ...
    public function getProfitLossDetails($business_id, $location_id, $start_date, $end_date)
    {
        ...
        //Get Opening stock
        $opening_stock = $this->getOpeningClosingStock($business_id, $day_before_start_date, $location_id, true);

        $opening_stock_by_sp = $this->getOpeningClosingStock($business_id, $day_before_start_date, $location_id, true, true);
