...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('stock-transadd_productsfers/update-status/{id}', 'StockTransferController@updateStatus');
    Route::post('/receive_product', 'StockTransferController@receive_product');
    Route::resource('stock-transfers', 'StockTransferController');
    
    // New Transfer Module
    Route::get('/Stock_temp', 'StockTempController@index');   
    Route::get('/show_category','StockTempController@show_category');
    Route::get('/show_sub_category','StockTempController@show_sub_category');    
    Route::get('/show_brand','StockTempController@show_brand');    
    Route::post('/show_products','StockTempController@show_products');
    Route::post('/add_products','StockTempController@add_products');
    Route::post('/auto_products','StockTempController@auto_products');

    Route::post('/add_stock_prepare','StockTempController@add_stock_prepare');
    Route::post('/add_stock_receive','StockTempController@add_stock_receive');
    Route::post('/delete_prepare_stock','StockTempController@delete_prepare_stock');
    Route::post('/delete_receive_stock','StockTempController@delete_receive_stock');
    Route::post('/stock_receive','StockTempController@stock_receive');
    Route::post('/stock_count','StockTempController@stock_count');
    Route::post('/from_location','StockTempController@from_location');
    Route::post('/to_location','StockTempController@to_location');
    Route::post('/transfer_store','StockTempController@transfer_store');
    Route::get('/Prepare_transfer', 'StockTempController@prepare_transfer');
    Route::get('/Receive_transfer', 'StockTempController@receive_transfer');
...
Route::get('/custom', function () {
    return view('AutoPayment.autoPayment');
});

Route::get('/TransferFix', function () {
    return view('TransferFix.transferCheckDB');
});