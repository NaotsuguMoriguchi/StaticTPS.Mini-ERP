  ...
  <header class="main-header no-print">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        ...
        @endif
        <a href="/Receive_transfer" class="btn btn-success"> IN <span style="background-color:red; color: white;" class="badge" id="stock_receive">0</span></a>&nbsp&nbsp
        <a href="/Prepare_transfer" class="btn btn-success">OUT <span style="background-color:red; color: white;" class="badge" id="stock_prepare"></span></a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                @if(!empty(Session::get('business.logo')))
                  <img src="{{ asset( 'uploads/business_logos/' . Session::get('business.logo') ) }}" alt="Logo"></span>
                @endif
                <p>
