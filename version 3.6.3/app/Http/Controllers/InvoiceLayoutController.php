...
class InvoiceLayoutController extends Controller
{
    ...
    public function __construct(Util $commonUtil)
    {
        ...
        $this->designs = ['classic' => 'Classic (For normal printer)',
                ...
                'slim' => 'Slim (Recommended for thermal line receipt printer, 80mm paper size)',
                'slim2' => 'Slim 2 (Recommended for thermal line receipt printer, 80mm and 58mm paper size)'
            ];
    }
